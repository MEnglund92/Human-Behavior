"""Fix social_animal_assets.json legacy assets (sa_ch01a..sa_ch09b): add
...
PATH = os.path.join(HERE, "..", "generated_assets", "social_animal_assets.json")

sys.path.insert(0, HERE)
from socialanimal_p2_data_a import CHAPTERS as A
from socialanimal_p2_data_b import CHAPTERS as B
