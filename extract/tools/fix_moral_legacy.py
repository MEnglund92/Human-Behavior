"""Fix moral_animal_assets.json legacy assets (ch01..ch18): add player_mission,
...
PATH = os.path.join(HERE, "..", "generated_assets", "moral_animal_assets.json")

sys.path.insert(0, HERE)
from moral_p2_data_a import CHAPTERS as A
from moral_p2_data_b import CHAPTERS as B
from moral_p2_data_c import CHAPTERS as C
