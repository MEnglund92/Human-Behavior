"""Phase 2 generator: per-chapter deep extraction for Predictably Irrational
(Dan Ariely).

Adds one chapter entry (pi00..pi15) per book section (Introduction, Ch1..Ch15),
each with 5 assets (one per asset type), while keeping the existing topical
entries (ch_intro, ch01..ch15) untouched.

Run from the repo root:
    python extract/tools/gen_predictably_p2.py
"""
...
OUT = os.path.join(HERE, "..", "generated_assets", "predictably_irrational_assets.json")

sys.path.insert(0, HERE)
from predictably_p2_data_a import CHAPTERS as DATA_A
from predictably_p2_data_b import CHAPTERS as DATA_B
from predictably_p2_data_c import CHAPTERS as DATA_C
