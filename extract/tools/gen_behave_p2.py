"""Phase 2 generator: per-chapter deep extraction for Behave (Robert Sapolsky).

Adds one chapter entry (bh00..bh18) per book section (Introduction, Ch1..Ch17,
Epilogue), each with 5 assets (one per asset type), while keeping the existing
topical entries (ch01..ch18) untouched.

Run from the repo root:
    python extract/tools/gen_behave_p2.py
"""
...
OUT = os.path.join(HERE, "..", "generated_assets", "behave_assets.json")

sys.path.insert(0, HERE)
from behave_p2_data_a import CHAPTERS as DATA_A
from behave_p2_data_b import CHAPTERS as DATA_B
from behave_p2_data_c import CHAPTERS as DATA_C
