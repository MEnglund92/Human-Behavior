"""Phase 2 generator: per-chapter deep extraction for What Every BODY Is Saying
(Joe Navarro & Marvin Karlins).

Adds one chapter entry (wb01..wb09) per book chapter (Ch1..Ch9), each with 5
assets (one per asset type), while keeping the existing topical entries
(foreword, ch01..ch09) untouched.

Run from the repo root:
    python extract/tools/gen_whatbody_p2.py
"""
...
OUT = os.path.join(HERE, "..", "generated_assets", "what_every_body_assets.json")

sys.path.insert(0, HERE)
from whatbody_p2_data_a import CHAPTERS as DATA_A
from whatbody_p2_data_b import CHAPTERS as DATA_B
from whatbody_p2_data_c import CHAPTERS as DATA_C
