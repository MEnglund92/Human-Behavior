"""Phase 2 generator: per-chapter deep extraction for The Definitive Book of
Body Language (Barbara & Allan Pease).

Adds one chapter entry (df00..df19) per book chapter (Introduction + Ch1..Ch19),
each with 5 assets (one per asset type), while keeping the existing topical
entries (intro, ch01..ch19) untouched.

Run from the repo root:
    python extract/tools/gen_definitive_p2.py
"""
...
OUT = os.path.join(HERE, "..", "generated_assets", "definitive_body_language_assets.json")

sys.path.insert(0, HERE)
from definitive_p2_data_a import CHAPTERS as DATA_A
from definitive_p2_data_b import CHAPTERS as DATA_B
from definitive_p2_data_c import CHAPTERS as DATA_C
from definitive_p2_data_d import CHAPTERS as DATA_D
from definitive_p2_data_e import CHAPTERS as DATA_E
