"""Fix mans_search_meaning_assets.json legacy assets (part1, part2, postscript):
...
PATH = os.path.join(HERE, "..", "generated_assets", "mans_search_meaning_assets.json")

sys.path.insert(0, HERE)
from mans_p2_data_a import CHAPTERS
...
ID_NUM = {"part1": 1, "part2": 2, "postscript": 3}
    ...
    for ch in data["chapters"]:
        ...
        for a in ch["assets"]:
            ...
            if "player_mission" not in a:
                a["player_mission"] = a.get("stage_1_question", a.get("question", a.get("description", "")))
                changed = True
