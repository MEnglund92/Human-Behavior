"""Phase 2 generator: per-chapter deep extraction for The Moral Animal
(Robert Wright).

Adds one chapter entry (ma00..ma18) per book section (Introduction, Ch1..Ch18),
each with 5 assets (one per asset type), while keeping the existing topical
entries (ch01..ch18) untouched.

Run from the repo root:
    python extract/tools/gen_moral_p2.py
"""
...
OUT = os.path.join(HERE, "..", "generated_assets", "moral_animal_assets.json")

sys.path.insert(0, HERE)
from moral_p2_data_a import CHAPTERS as DATA_A
from moral_p2_data_b import CHAPTERS as DATA_B
from moral_p2_data_c import CHAPTERS as DATA_C
