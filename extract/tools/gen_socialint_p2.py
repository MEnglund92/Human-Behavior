"""Phase 2 generator: per-chapter deep extraction for Social Intelligence
(Daniel Goleman).

Adds one chapter entry (si00..si22) per book section (Prologue, Ch1..Ch21,
Epilogue), each with 5 assets (one per asset type), while keeping the existing
topical entries (ch01..ch21) untouched.

Run from the repo root:
    python extract/tools/gen_socialint_p2.py
"""
...
OUT = os.path.join(HERE, "..", "generated_assets", "social_intelligence_assets.json")

sys.path.insert(0, HERE)
from socialint_p2_data_a import CHAPTERS as DATA_A
from socialint_p2_data_b import CHAPTERS as DATA_B
from socialint_p2_data_c import CHAPTERS as DATA_C
from socialint_p2_data_d import CHAPTERS as DATA_D
from socialint_p2_data_e import CHAPTERS as DATA_E

CHAPTERS = DATA_A + DATA_B + DATA_C + DATA_D + DATA_E
