"""Phase 2 generator: per-chapter deep extraction for The Body Language of Liars
(Lillian Glass).

Adds one chapter entry (gl13..gl24) per book chapter (Ch1..Ch12), each with 5
assets (one per asset type, mirroring the part-level sub-section rule), while
keeping the existing topical entries (gl01..gl12) untouched.

Run from the repo root:
    python extract/tools/gen_glass_p2.py
"""
...
OUT = os.path.join(HERE, "..", "generated_assets", "glass_liars_assets.json")

sys.path.insert(0, HERE)
from glass_p2_data_a import CHAPTERS as DATA_A
from glass_p2_data_b import CHAPTERS as DATA_B
from glass_p2_data_c import CHAPTERS as DATA_C
from glass_p2_data_d import CHAPTERS as DATA_D
