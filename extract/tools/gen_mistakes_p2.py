"""Phase 2 generator: per-chapter deep extraction for Mistakes Were Made
(But Not by Me) (Carol Tavris & Elliot Aronson).

Adds one chapter entry (mk00..mk09) per book section (Introduction, Ch1..Ch9),
each with 5 assets (one per asset type), while keeping the existing topical
entries (ch00a..ch09) untouched.

Run from the repo root:
    python extract/tools/gen_mistakes_p2.py
"""
...
OUT = os.path.join(HERE, "..", "generated_assets", "mistakes_assets.json")

sys.path.insert(0, HERE)
from mistakes_p2_data_a import CHAPTERS as DATA_A
from mistakes_p2_data_b import CHAPTERS as DATA_B
