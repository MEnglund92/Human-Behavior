...
### Git note
Only 3 commits exist; `extract/` is untracked. Before moving machines: commit
the whole working tree (or copy the folder). Do NOT commit the source PDFs if
licensing is a concern — the JSONs are derived content.
